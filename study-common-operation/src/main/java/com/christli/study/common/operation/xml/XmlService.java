package com.christli.study.common.operation.xml;
import com.christli.study.common.operation.xml.util.Dom4jUtils;
import org.dom4j.*;
...
public class XmlService {
    ...
    public static void getFeed() {
        ...
        try {
            ...
            FileWriter out = new FileWriter("xml/foo.xml");
            document1.write(out);
            out.close();
            //
