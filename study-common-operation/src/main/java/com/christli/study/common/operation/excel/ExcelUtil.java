package com.christli.study.common.operation.excel;
...
public class ExcelUtil {
    ...
    public static void CreateNewWorkbook() {
        ...
        try {
            OutputStream fileOut = new FileOutputStream("excel/CreateNewWorkbook.xls");
            wb.write(fileOut);
        } catch (Exception e) {
            e.printStackTrace();
        }
        Workbook wb2 = new XSSFWorkbook();
        try (OutputStream fileOut = new FileOutputStream("excel/CreateNewWorkbook.xlsx")) {
            wb2.write(fileOut);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void CreateNewSheet() {
        ...
        Sheet sheet2 = wb.createSheet("the second sheet");
        String safeName = WorkbookUtil.createSafeSheetName("[O'Brien's sales*?]"); // returns " O'Brien's sales   "
        Sheet sheet3 = wb.createSheet(safeName);
        try {
            OutputStream fileOut = new FileOutputStream("excel/CreateNewSheet.xls");
            wb.write(fileOut);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void CreateNewCell() {
        ...
        try {
            OutputStream fileOut = new FileOutputStream("excel/CreateNewCell.xls");
            wb.write(fileOut);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void OpenExcelByFile(){
        try {
            Workbook wb = WorkbookFactory.create(new File("excel/CreateNewWorkbook.xls"));
            //读取
    ...
    public static void OpenExcelByFileInputStream(){
        try {
            Workbook wb = WorkbookFactory.create(new FileInputStream("excel/CreateNewWorkbook.xls"));
            //遍历
        }catch (Exception ex){
