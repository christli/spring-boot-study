...
import com.christli.study.common.operation.xml.domain.*;
...
public class XmlUtil {
    ...
    public static void testXsteam() {
        ...
        /** 1.不设置别名输出
         * <com.christli.study.common.operation.xml.domain.Blog>
         *   <writer>
         *     <name>Guilherme Silveira</name>
         *   </writer>
         *   <entries>
         *     <com.christli.study.common.operation.xml.domain.Entry>
         *       <title>first</title>
        ...
        msg = new User(1, "christli",addressList);
        System.out.println(xstream.toXML(msg));
        /** 6.使用注解 子节点是列表
         * <user>
         *   <id>1</id>
